...
public class TD
{
    ...
    public async Task<TeamDynamix.Api.Tickets.Ticket> PostUpdateTicketAsync(int appId, TeamDynamix.Api.Tickets.Ticket ticket, bool notify = false)
    {
        // convert to JSON
    ...
    /// <param name="notify">Whether to notify the person responsible.</param>
    /// <returns>The updated Ticket.</returns>
    public async Task<TeamDynamix.Api.Tickets.Ticket> PatchUpdateTicketAsync(int appId, int id, TeamDynamix.Api.JsonPatchOperation[] content, bool notify = false)
    {
        // declare the method
    ...
    public async Task<TeamDynamix.Api.Feed.ItemUpdate[]> GetFeedEntriesAsync(int appId, int id)
    {
        ...
        TeamDynamix.Api.Feed.ItemUpdate[] item = JsonConvert.DeserializeObject<TeamDynamix.Api.Feed.ItemUpdate[]>(sResponse); // convert response to ticket
        return item;
    }
    ...
    public async Task<TeamDynamix.Api.Tickets.Ticket> CreateTicketAsync(int appId, TeamDynamix.Api.Tickets.Ticket ticket, TeamDynamix.Api.Tickets.TicketCreateOptions options = null)
    {
        ...
        options = options ?? newOptions; // a way to get around complie time constant arguments
    ...
    public (int limit, int remaining, DateTime reset) CheckRateLimit()
    {
        int limit = -1;
